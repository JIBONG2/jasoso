...
export const generateInitialSOP = async (type: string, info: { 
  ...
  4. Markdown 형식을 사용하여 제목(#)과 소제목(##)을 구분해 주세요 (예: # [자기소개서], ## 1. 지원 동기).
  5. 소제목은 실제 문서처럼 명확하게 달아 가독성을 높여주세요.
  6. 구체적인 수치나 에피소드가 있다면 강조하여 진정성을 높여주세요.
  7. 문체는 정중하고 전문적인 어투(~합니다)를 기본으로 하되 선택된 스타일에 맞춰 변주해주세요.`;
